...
int main(void)
{
    ...
    do
    {
        ...
        lista.push_back(aux);
                ...
                break;
        case 2:
            cout << "Cancion a eliminar: "; getlina(cin, tit);
            for(auto iter = lista.begin(); iter != list.end(); ++iter){
...
{
    for (T elemnto : canciones)
    {
        if (elemnto.titulo.compare(tit) == 0)
        {
